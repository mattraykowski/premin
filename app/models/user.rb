class User < ActiveRecord::Base
  ...
  attr_accessible :name, :account_id, :is_site_admin, :account_name
  ...
  def create_account
    ...
    account = Account.find_by_subdomain(self.account_name)
    if account.nil?
      self.account = Account.create!(subdomain: self.account_name)
    else
